...
export const DialogCopy = ({ hasActions = false, children, onClose }) => {
  return (
    ...
    --> */}
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto">
        ...
        --> */}
          <div className="relative w-full overflow-hidden rounded-lg bg-white shadow-xl transition-all sm:max-w-7xl">
